...
class ProjectsCatController extends Controller
{
	...
	{
		$model=new ProjectsCat;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['ProjectsCat']))
		{
			$model->attributes=$_POST['ProjectsCat'];
			if($model->save())
	...
	{
		$model=ProjectsCat::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='projects-cat-form')
		{
